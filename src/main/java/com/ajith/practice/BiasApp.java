    ...
    public class BiasApp extends Application {
       // private MediaPlayer musicPlayer;
        ...
        public void start(Stage primaryStage) {
            ...
            StackPane prayerLayout = new StackPane();


            prayerLayout.getChildren().addAll(
                    backgroundView,
                    desktopIcons
            );
            ...
            Scene scene = new Scene(prayerLayout, 600, 400);
...
*/
            ...
            analyzerApps.setOnMouseClicked(actionEvent -> {
                ...
                prayerLayout.getChildren().add(analyzerLayout);
                ...
                xButton.setOnAction(backEvent -> {
                    prayerLayout.getChildren().remove(analyzerLayout);
                });
            });
            ...
            newsIconBox.setOnMouseClicked(actionEvent -> {
                ...
                Image[] articles = {
                        ...
                        new Image("file:src/images/news6.png"),
                        new Image("file:src/images/news7.png"),
                        new Image("file:src/images/news8.png"),
                        new Image("file:src/images/news9.png"),
                        new Image("file:src/images/news10.png"),
                        new Image("file:src/images/news11.png"),
                        new Image("file:src/images/news12.png")
                ...
                newsPane.getChildren().add(xButton);
                StackPane.setAlignment(xButton,Pos.TOP_RIGHT);
                StackPane.setMargin(xButton, new Insets(30, 410, 400, 40));

                StackPane.setAlignment(nextButton, Pos.BOTTOM_RIGHT);
                StackPane.setMargin(nextButton, new Insets(0, 410, 40, 40));
                ...
                xButton.setOnAction(backEvent -> {
                    prayerLayout.getChildren().remove(newsPane);
                });
                prayerLayout.getChildren().add(newsPane);
            ...
            videoIconpic.setOnMouseClicked(event -> {
              //  musicPlayer.pause();
                ...
                prayerLayout.getChildren().add(videoPane);
                ...
                closeButt.setOnAction(e -> {
                    cyberFemplayer.stop();
                    cyberFemplayer.dispose();


                    prayerLayout.getChildren().remove(videoPane);
                  //  musicPlayer.play();
            ...
            womanIconBox.setOnMouseClicked(actionEvent1 -> {
                ...
                exit.setOnAction(event -> {
                    prayerLayout.getChildren().remove(scrollPane);
                });


                prayerLayout.getChildren().add(scrollPane);
            ...
            passwordIconBox.setOnMouseClicked(event -> {
                ...
                prayerLayout.getChildren().add(passwordScreen);


                enterButton.setOnAction(e -> {


                    if (passwordBox.getText().equals("Woman")) {


                     //  musicPlayer.stop();


                        prayerLayout.getChildren().clear();
                        ...
                        psa.setOnError(() -> {
                            System.out.println("MEDIA ERROR: " + psa.getError());
                        });


                        psaPlayer.setOnError(() -> {
                            System.out.println("PLAYER ERROR: " + psaPlayer.getError());
                        });


                        psaView.fitWidthProperty().bind(prayerLayout.widthProperty());
                        psaView.fitHeightProperty().bind(prayerLayout.heightProperty());
                        psaView.setPreserveRatio(true);


                        prayerLayout.getChildren().add(psaView);

                        psaPlayer.setOnReady(() -> {
                            System.out.println("PSA READY");
                            psaPlayer.play();
                        });
